...
export const mockSources: SourceRow[] = [
  {
    ...
    active: true,
    last_sync_at: now,
    notes: "Primary regulatory trigger source for compliance-driven opportunities.",
    created_at: now,
    updated_at: now,
  },
  {
    ...
    active: true,
    last_sync_at: now,
    notes: "Keyword volume, CPC, and competition enrichment.",
    created_at: now,
    updated_at: now,
  },
  {
    id: "src3",
    name: "G2 Reviews",
    workflow_lane: "market_wedge_validation",
    source_type: "market_proof",
    ...
    active: true,
    last_sync_at: now,
    notes: "Competitor landscape and complaint theme extraction.",
    created_at: now,
    updated_at: now,
  },
  {
    ...
    active: true,
    last_sync_at: now,
    notes: "Workflow friction signals from open-source and dev tool repos.",
    created_at: now,
    updated_at: now,
  },
  {
    ...
    active: false,
    last_sync_at: null,
    notes: "Spend evidence for B2G wedge validation. Connector not yet wired.",
    created_at: now,
    updated_at: now,
  },
];
