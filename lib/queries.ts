...
export async function createOpportunity(
  ...
  const opportunity: OpportunityRow = {
    ...
    friction_score: null,
    complaint_signal_strength: null,
    primary_buyer: (data.primary_buyer as string) ?? (data.target_buyer as string) ?? null,
    secondary_buyers: (data.secondary_buyers as string[]) ?? null,
    buyer_tags: (data.buyer_tags as string[]) ?? null,
    industry_tags: (data.industry_tags as string[]) ?? null,
    asset_strategy: (data.asset_strategy as string) ?? null,
    asset_path_1: null,
    asset_path_2: null,
    asset_path_3: null,
    asset_reason: null,
